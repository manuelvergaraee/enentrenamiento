                ...
                <div class="lp-view-tabs">
                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane active" id="lp-view-content">
                            <div id="wrapper-iframe" style="width:100%;">
                            {% if lp_mode == 'fullscreen' %}
                                <iframe id="content_id_blank" name="content_name_blank" src="blank.php" style="width:100%;" border="0" frameborder="0" allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>
                            {% else %}
                                <iframe id="content_id" name="content_name" src="{{ iframe_src }}" style="width:100%;" border="0" frameborder="0" allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true" ></iframe>
                            {% endif %}
            ...
            .on('load', function () {
                $.frameReady(function () {
                    ...
                    load: [
                        ...
                        {type: 'stylesheet', id: '_fr6', src: 'https://comunidad.enentrenamiento.com/recursos/css/frames.css'},
                        {type: 'script', id: '_fr2', src: '{{ _p.web_lib }}javascript/jquery.highlight.js'},
                        {type: 'script', id: '_fr3', src: '{{ _p.web_main }}glossary/glossary.js.php'},
                        {type: 'script', id: '_fr8', src: '{{ _p.web }}web/assets/BeargaraJS/iframeResizer.contentWindow.min.js'},
                        {type: 'script', id: '_fr11', src: '{{ _p.web }}web/assets/BeargaraJS/scriptframe.js'}
                    ]
                });
            });
    });
