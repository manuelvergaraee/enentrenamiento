...
class Template
{
    ...
    public function setCssCustomFiles()
    {
        ...
        /* Validacion para Cursos UPB */
        if ( $this->course_id == "UPBCOLABORACIONENLINEA") {
             $css[] = api_get_cdn_path(api_get_path(WEB_CSS_PATH).'themes/academica/'.'default.css');
        }

        if ( $this->course_id == "UPBSEGURIDADDIGITAL") {
             $css[] = api_get_cdn_path(api_get_path(WEB_CSS_PATH).'themes/academica/'.'default.css');
